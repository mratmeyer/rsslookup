          ...
          <div className="m-auto max-w-2xl p-8 lg:p-12 min-h-screen">
            <body>
              ...
              <div className="text-center">
                ...
                <p className="font-bold">© Copyright <a className="hover:opacity-75" target="_blank" rel="noreferrer noopener" href="https://www.maxratmeyer.com/?utm_source=rssfinder">Max Ratmeyer</a> 2022</p>
              </div>
            </body>
          </div>
        </div>
